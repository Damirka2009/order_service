...
const file_order_proto_rawDesc = "" +
	...
	".api.OrderR\x06orders2\xfd\x03\n" +
	"\fOrderService\x12e\n" +
	"\vCreateOrder\x12\x17.api.CreateOrderRequest\x1a\x18.api.CreateOrderResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/v1/orders/order_service\x12X\n" +
	"\bGetOrder\x12\x14.api.GetOrderRequest\x1a\x15.api.GetOrderResponse\"\x1f\x82\xd3\xe4\x93\x02\x19:\x01*\"\x14/v1/orders/get_order\x12d\n" +
	"\vUpdateOrder\x12\x17.api.UpdateOrderRequest\x1a\x18.api.UpdateOrderResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/orders/update_order\x12d\n" +
	"\vDeleteOrder\x12\x17.api.DeleteOrderRequest\x1a\x18.api.DeleteOrderResponse\"\"\x82\xd3\xe4\x93\x02\x1c:\x01*\"\x17/v1/orders/delete_order\x12`\n" +
	"\n" +
	"ListOrders\x12\x16.api.ListOrdersRequest\x1a\x17.api.ListOrdersResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/v1/orders/list_ordersB\x0eZ\fpkg/api/testb\x06proto3"
